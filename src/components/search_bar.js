...
class SearchBar extends Component {
	...
	render() {
		...
		// whenever we change the value, the event handler runs, we set the state with the new value of the input. it re-renders and pushes the new data into the DOM every time it's updated
		return (
			<div>
